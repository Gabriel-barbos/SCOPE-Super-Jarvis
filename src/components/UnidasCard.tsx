...
import { Loader2, Eye, Car, Play, Timer, CheckCircle2, AlertCircle } from "lucide-react";
...
export default function UnidasCard() {
  ...
  const handleBuscarVeiculos = async () => {
    ...
    try {
      ...
      const resultado = await UnidasService.buscarVeiculosSemGrupo(
        500,
        (processados, totalCount, descricao) => {
        ...
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button variant="outline" size="sm">
              Programar <Timer className="ml-1 w-4 h-4" />
            </Button>
            <Button
              variant="default"
