...
import { FileSearch, FileDown, CheckCircle2, XCircle, Loader2 } from "lucide-react";
        ...
        <>
            <Card className="p-6 shadow-md border border-border">
                <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-red-600 to-orange-500 flex items-center justify-center flex-shrink-0">
                        <FileSearch className="w-6 h-6 text-white" />
                    </div>

                    <div className="flex-1">
                        <h2 className="text-xl font-semibold">Análise de Base NÃO USAR (NAO ESTA PRONTO)</h2>
...
export default ReportCheckCard;